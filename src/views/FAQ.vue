  ...
  <div class="max-w-3xl mx-auto p-4">
    ...
    <div class="space-y-6">
      ...
      <div>
        ...
        <p>Wir sind die meiste Zeit in abgelegenen Gebieten unterwegs. Ein vorzeitiger Abbruch ist schwierig. Möglichkeiten sind, zu einer Straße zu wandern, von der aus man trampen kann, oder zur nächsten Hütte zu gelangen, von der aus Transport organisiert werden kann. Man sollte sich darauf einstellen, 1-2 Tageswanderungen von der nächsten Zivilisation entfernt zu sein.</p>
      </div>
      <div>
        <h3 class="font-semibold">Wie navigieren wir?</h3>
        <p>Wir nutzen die norwegische Wanderseite "UT.no", auf der alle Routen verzeichnet sind. Zudem gibt es vor Ort Markierungen (rote Ts) auf den Wegen. GPS funktioniert in der Region, aber in unwegsamem Gelände (Matsch, Flussdurchquerungen, Steinfelder) kann es schwierig sein, den besten Weg zu finden.</p>
      </div>
      <div>
        <h3 class="font-semibold">Benötigen wir ein Visum für Norwegen?</h3>
        <p>Nein, deutsche Staatsbürger können visumfrei nach Norwegen einreisen. Du brauchst lediglich einen Personalausweis oder Reisepass.</p>
      </div>
      <div>
        <h3 class="font-semibold">Wie versorgen wir uns mit Wasser?</h3>
        <p>Das Wasser in der Hardangervidda kann problemlos getrunken werden, da es keine Landwirtschaft gibt. Eine kleine Flasche (ca. 1 Liter) reicht aus, um bis zum nächsten Fluss zu kommen. Wasserquellen sind häufig.</p>
      </div>
      <div>
      ...
      <div>
        <h3 class="font-semibold">Wie ist die Verpflegung in den Hütten?</h3>
        <p>Im Komfortpaket sind drei Mahlzeiten enthalten. Abends gibt es meist ein 3-Gänge-Menü (Suppe, Hauptgang, Nachspeise) mit deftiger, oft fleischhaltiger Kost. Vegetarische Optionen sind begrenzt. Morgens gibt es ein Frühstücksbuffet, von dem man sich eine Brotzeit für mittags vorbereiten kann.</p>
      </div>
      <div>
